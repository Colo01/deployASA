  ...
  return (
    <div className={style.navbar}>
      <div className={style.leftSection}>
        ...
        />
        {/* Texto "Hola [usuario]" */}
        <span className={style.userGreeting}>
      ...
      <div className={style.menu}>
        {role === "AD" && (
          <>
            ...
            <div
              className={style.menuItem}
              onClick={() => handleNavigation("/turnos_operator")}
            >
              Entregas
            </div>
            <div
              className={style.menuItem}
              onClick={() => handleNavigation("/appointments_history")}
            >
              Turnos
            </div>
          </>
        ...
        {role === "CL" && (
          <>
            ...
            <div
              className={style.menuItem}
              onClick={() => handleNavigation("/myappointments")}
            >
              Mis Turnos
            </div>
          </>
