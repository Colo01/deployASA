// client/src/commons/AppointmentDetailsOperator.jx
...
const AppointmentDetailsOperator = () => {
  ...
  const fakeAppointments = [
    {
      ...
      time: "10:30",
      available: false,
      branchOffice: ["62c621154bf17c41fbe9cc97"],
      user: ["62d06cdcd7369af706902545"],
  ...
  return pickedDate.date ? (
    <div className={style.userDetails}>
      ...
      <ul>
        {<li>Campaña: {pickedBranchOffice.location.toUpperCase()}</li>}
