// client/src/views/OfficeDetails.jsx
...
const OfficeDetails = ({ office, selectOffice }) => {
  ...
  const handleSubmit = (values) => {
    Confirm.show(
      "miTurno",
      "¿Confirma que desea aplicar los cambios en esta campaña?",
      "Si",
      "No",
      () => {
        axios
                ...
                <div className={style.dataContainer}>
                  <div className={style.leftDataContainer}>
                    <div className={style.generalContainer}>
                      ...
                      <ul>
                        <li>ID Campaña:&emsp;{office._id}</li>
                        <li>
                          Nombre:&emsp;
                          {capitalize(office.location + " - " + office.address)}
                        </li>
                  ...
                  <div className={style.rightDataContainer}>
                    ...
                    <div className={style.generalContainer}>
                      <div className={style.generalContainerTitle}>
                        <h5>Operadores asignados a la campaña</h5>
                        <Button
                          variant="secondary"
                          className={style.buttons}
                          onClick={() => {
